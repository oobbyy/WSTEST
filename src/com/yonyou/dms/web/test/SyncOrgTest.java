...
import com.yonyou.dms.web.client.syncorg.SyncOrgInfo;
...
//	private final static String Server_Url = "http://localhost:8080/dms.web/services/querySQL?wsdl";
	private final static String Server_Url = "http://localhost:8080/dms.web/services/syncOrgInfo?wsdl";
	private SyncOrgInfo iWebService;
	private SyncOrgInfoPortType portType;

	protected void setUp() throws Exception {
		iWebService = new SyncOrgInfoLocator();
		portType = iWebService.getsyncOrgInfoHttpSoap11Endpoint(new URL(Server_Url));
	}
