...
public class QuerySQLLocator extends org.apache.axis.client.Service implements com.yonyou.dms.web.client.sqlinfo.QuerySQL {
    ...
    public com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType getquerySQLHttpSoap12Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType getquerySQLHttpSoap12Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap12BindingStub _stub = new com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap12BindingStub(portAddress, this);
    ...
    public com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType getquerySQLHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType getquerySQLHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap11BindingStub _stub = new com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap12BindingStub _stub = new com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap12BindingStub(new java.net.URL(querySQLHttpSoap12Endpoint_address), this);
                _stub.setPortName(getquerySQLHttpSoap12EndpointWSDDServiceName());
                return _stub;
            }
            if (com.yonyou.dms.web.client.sqlinfo.QuerySQLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap11BindingStub _stub = new com.yonyou.dms.web.client.sqlinfo.QuerySQLSoap11BindingStub(new java.net.URL(querySQLHttpSoap11Endpoint_address), this);
                _stub.setPortName(getquerySQLHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
        }
